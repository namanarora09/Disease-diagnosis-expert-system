...
def preprocess():
	...
	diseases = open("D:\Medical-Expert-System-Knowledge-Base-master\diseases.txt")
	diseases_t = diseases.read()
	diseases_list = diseases_t.split("\n")
	diseases.close()
	for disease in diseases_list:
		disease_s_file = open("D:\Medical-Expert-System-Knowledge-Base-master\Disease symptoms/" + disease + ".txt")
		disease_s_data = disease_s_file.read()
		s_list = disease_s_data.split("\n")
		diseases_symptoms.append(s_list)
		symptom_map[str(s_list)] = disease
		disease_s_file.close()
		disease_s_file = open("D:\Medical-Expert-System-Knowledge-Base-master\Disease descriptions/" + disease + ".txt")
		disease_s_data = disease_s_file.read()
		d_desc_map[disease] = disease_s_data
		disease_s_file.close()
		disease_s_file = open("D:\Medical-Expert-System-Knowledge-Base-master\Disease treatments/" + disease + ".txt")
		disease_s_data = disease_s_file.read()
